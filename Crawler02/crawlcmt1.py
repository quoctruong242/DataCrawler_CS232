...
def initDriver():
    CHROMEDRIVER_PATH = 'Scraping/chromedriver.exe'
...
def getAmountOfComments(driver,postId, numberCommentTake):
    try:
        with open('comments.csv', 'a', encoding='utf-8') as f1:
            f1.write(postId + os.linesep)
...
if (isLive):
    getnumOfPostFanpage(driver, 'UITcfs', 100, 'posts.csv')
